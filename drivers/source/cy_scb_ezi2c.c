...
*
* This function must be called during execution of \ref Cy_SysPm_SystemEnterDeepSleep.
* To do this, register this function as a callback before calling
* \ref Cy_SysPm_SystemEnterDeepSleep : specify \ref CY_SYSPM_DEEPSLEEP as the callback
    ...
    switch (mode)
    {
            ...
            */
            ...
            if (_FLD2BOOL(SCB_CTRL_EC_AM_MODE, SCB_CTRL(locBase)))
            {
                ...
                */
                ...
                /* IMPORTANT (add code here for disable the I2C clock): 
        ...
        case CY_SYSPM_AFTER_TRANSITION:
        {
            if (_FLD2BOOL(SCB_CTRL_EC_AM_MODE, SCB_CTRL(locBase)))
            {
                ...
                /* IMPORTANT (add code here for enable the I2C clock): 
...
*
*******************************************************************************/
cy_en_syspm_status_t Cy_SCB_EZI2C_HibernateCallback(cy_stc_syspm_callback_params_t const *callbackParams, cy_en_syspm_callback_mode_t mode)
{
    CySCB_Type *locBase = (CySCB_Type *) callbackParams->base;
    cy_stc_scb_ezi2c_context_t *locContext = (cy_stc_scb_ezi2c_context_t *) callbackParams->context;
