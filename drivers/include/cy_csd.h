...
* an upper level. When using CapSense, those blocks are managed by
* middleware.
*
********************************************************************************
...
* without the need for re-initialization. In the case of wake up from Hibernate
* power mode, the CSD HW block does not retain configuration and it requires
* re-initialization.
*
* \note
...
*    any kind of conversion only after 10 us from Deep Sleep / Hibernate exit.
*
