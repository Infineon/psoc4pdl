...
typedef enum
{
    ...
    PCLK_PASS_CLOCK_SAR             = 0x000Cu   /* pass.clock_sar */
} en_clk_dst_t;
...
typedef enum
{
    ...
    TRIG0_IN_PASS_DSI_SAR_SAMPLE_DONE = 0x00000010u, /* pass.dsi_sar_sample_done */
    TRIG0_IN_PASS_TR_SAR_OUT        = 0x00000011u, /* pass.tr_sar_out */
    TRIG0_IN_PASS_DSI_CTB_CMP0      = 0x00000012u, /* pass.dsi_ctb_cmp0 */
    TRIG0_IN_PASS_DSI_CTB_CMP1      = 0x00000013u, /* pass.dsi_ctb_cmp1 */
...
typedef enum
{
    ...
    TRIG1_IN_PASS_DSI_SAR_SAMPLE_DONE = 0x00000110u, /* pass.dsi_sar_sample_done */
    TRIG1_IN_PASS_TR_SAR_OUT        = 0x00000111u, /* pass.tr_sar_out */
    TRIG1_IN_PASS_DSI_CTB_CMP0      = 0x00000112u, /* pass.dsi_ctb_cmp0 */
    TRIG1_IN_PASS_DSI_CTB_CMP1      = 0x00000113u, /* pass.dsi_ctb_cmp1 */
...
typedef enum
{
    TRIG1_OUT_PASS_TR_SAR_IN        = 0x40000100u /* pass.tr_sar_in */
